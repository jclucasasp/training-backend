...
CREATE TABLE organisation (
                              ...
                              -- Soft-disable: if not null, the org is inactive
                              org_ended_at DATETIME NULL,

                              -- Index for soft-delete filtering & auth lookups
                              INDEX idx_org_status (org_ended_at, org_id),
...
CREATE TABLE api_key (
                         ...
                         INDEX idx_api_auth (ak_key_hash, ak_ended_at, ak_org_id)
) ENGINE=InnoDB;
...
CREATE TABLE course (
                        ...
                        c_updated_at DATETIME NULL ON UPDATE CURRENT_TIMESTAMP,
                        c_ended_at DATETIME NULL, -- Soft-delete: if not null, the course is inactive
                        ...
                        INDEX idx_course_status (c_ended_at, c_id)
) ENGINE=InnoDB;
...
CREATE TABLE module (
                        ...
                        m_ended_at DATETIME NULL, -- Soft-delete: if not null, the module is inactive
                        ...
                        INDEX idx_module_status (m_ended_at, m_id)
) ENGINE=InnoDB;
...
CREATE TABLE section (
                         ...
                         s_ended_at DATETIME NULL, -- Soft-delete: if not null, the section is inactive
                         ...
                         INDEX idx_section_status (s_ended_at, s_id)
) ENGINE=InnoDB;
...
CREATE TABLE student_enrollment (
                                    ...
                                    se_student_id VARCHAR(100) NULL,
